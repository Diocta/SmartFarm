...
  },
    ...
    modalOverlay: {
        ...
        justifyContent: 'center',
        alignItems: 'center',
        backgroundColor: 'rgba(0, 0, 0, 0.6)', // Gelap dan transparan
    },
    modalContent: {
        width: '90%',
        padding: 20,
    ...
    modalButtonCancel: {
        backgroundColor: '#6b7280', // Abu-abu gelap untuk Cancel
    },
    modalButtonSave: {
        backgroundColor: '#10b981', // Hijau terang untuk Save
    },
    modalButtonText: {
        fontWeight: '700',
        color: 'white',
